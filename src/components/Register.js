          ...
          <div className="card-body p-md-5">
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form className="mx-1 mx-md-4" onSubmit={data.register_user}>
                  <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        ...
                        <small classNames="form-text text-muted">{data.Registerpage_error.error.first_name[0]}</small>
                        :null:null:null}
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      {data.Registerpage_error!=={}?data.Registerpage_error.status===400? "last_name" in data.Registerpage_error.error?
                        <small classNames="form-text text-muted">{data.Registerpage_error.error.last_name[0]}</small>
                        :null:null:null}
                    ...
                    <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        ...
                        <small classNames="form-text text-muted">{data.Registerpage_error.error.username[0]}</small>
                        :null:null:null}
                    ...
                    <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        ...
                        <small classNames="form-text text-muted">{data.Registerpage_error.error.email[0]}</small>
                        :null:null:null}
                    ...
                    <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        ...
                        data.Registerpage_error.error.password.map((error,index)=>
                          <small key={index} classNames="form-text text-muted">{error}</small>
                        ):null:null:null}
